  ...
  submitRegistration = (e) => {
    ...
    fetch('http://localhost:8000/signup', {
      ...
      headers: {
        ...
        'Authorization':
          'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6IkhBWkVMIiwiaWF0IjoxNjkxNDgzNDM5LCJleHAiOjE2OTE0ODQ2Mzl9._KtHYP0jHF6Deh7z5YXVTWHMkEoyxBlFkMMShqTqhRM',
      },
      body: JSON.stringify({
